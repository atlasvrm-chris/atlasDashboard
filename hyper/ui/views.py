...
ui_placeholders_view = UiView.as_view(template_name="ui/placeholders.html")
...
ui_links_view = UiView.as_view(template_name="ui/links.html")
ui_typography_view = UiView.as_view(template_name="ui/typography.html")
ui_utilities_view = UiView.as_view(template_name="ui/utilities.html")
